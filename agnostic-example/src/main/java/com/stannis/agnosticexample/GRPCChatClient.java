package com.stannis.agnosticexample;
...
public class GRPCChatClient {
    ...
    public void chat(String username) {
        ...
        StreamObserver<ChatMessage> requestObserver = getChatMessageStreamObserver();
        try {
    ...
    private StreamObserver<ChatMessage> getChatMessageStreamObserver() {
    ...
    public static void main(String[] args) {
        ...
        grpcChatClient.chat("Serghei Mizil");
    }
}
